...
module Hacienda
  module Wiring
    ...
    def publish_content_controller
      PublishContentController.new(github, content_digest, log)
    end

    def create_content_controller
      CreateContentController.new(github, content_digest)
    end

    def delete_content_controller
      DeleteContentController.new(github, log)
    end

    def update_content_controller
      UpdateContentController.new(github, content_digest, draft_content_store, log)
    end
